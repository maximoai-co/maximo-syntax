// pnpm --filter @maximo-syntax/core test src/custom-tools/__tests__/serialize.spec.ts

import { parametersSchema as z, defineCustomTool } from "@maximo-syntax/types"
