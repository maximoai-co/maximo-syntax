...
import { CodeActionName, CodeActionId } from "@maximo-syntax/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Maximo Syntax",
	FIX: "Fix with Maximo Syntax",
	IMPROVE: "Improve with Maximo Syntax",
	ADD_TO_CONTEXT: "Add to Maximo Syntax",
	NEW_TASK: "New Maximo Syntax Task",
} as const
