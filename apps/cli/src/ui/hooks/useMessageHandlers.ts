...
import type { ExtensionMessage, ClineMessage, ClineAsk, ClineSay, TodoItem } from "@maximo-syntax/types"
import { consolidateTokenUsage, consolidateApiRequests, consolidateCommands } from "@maximo-syntax/core/cli"
